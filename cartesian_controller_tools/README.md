...
alias mybuild="colcon build --packages-select cartesian_controller_tools && source install/setup.bash"
...
Located under `cartesian_controller_tools/cartesian_controller_tools`:
...
2. Run:
   ...
   myjoy
   myswitch_to_motion
   ros2 launch cartesian_controller_tools joystick_calibration.launch.py
   ros2 launch cartesian_controller_tools calibration_data_recorder.launch.py
   ```
...
ros2 launch cartesian_controller_tools joystick_{compliance|force}_control.launch.py
```
...
myrun
myswitch_to_force
ros2 launch cartesian_controller_tools zero_force_control.launch.py
```
